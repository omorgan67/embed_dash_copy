# Python script to copy over an embedded dashboard (that's been created by an embedded user) 
# using only api calls (no gzr, no lookml dashboards). Huge shoutout to Drake for the majority of the heavy 
# lifting. FYI, for shared lookml dashboards, you can use import_lookml_dashboard 
